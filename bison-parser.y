...
%token SFREPETA PANACAND REPETA OUTOPF INOPF RETURN MAIN LEFT_PAR RIGHT_PAR LEFT_BR RIGHT_BR PLUS MINUS DIV MUL MOD INOP OUTOP IFSTMT WHILESTMT INTDECL EQUALS OTHER SEMICOLON RELATION
